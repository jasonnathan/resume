if (Meteor.isClient) {
    ...
    Template.realtasia.rendered = function() {
        $('#grid').mixitup({transitionSpeed: 300});
        $('#realtasia-info').fancybox({
            fitToView: true,
            autoSize: true,
            autoResize: true,
            maxWidth: '550px',
            ...
            helpers: {
                ...
                title: "Sorry, content not available"
            },
            afterClose: function() {
...
function _init() {
    ...
    tl
            .from($('.fieldset h4'), 1, {left: "-100%", ease: Back.easeInOut})
